...
//------------------------------------------------------------------------------------
// rlCamera module is included (rcamera.h) and multiple predefined cameras are available: free, 1st/3rd person, orbital
...
// Support rlCompressData() and rlDecompressData() functions
...
// If not defined, still some functions are supported: rlImageFormat(), rlImageCrop(), rlImageToPOT()
...
// If not defined, still some functions are supported: rlTextLength(), rlTextFormat()
...
#define RL_USE_CPP_MANGLING  1
    ...
    #define RL_NS_BEGIN namespace rlgl {
    #define RL_NS_END }
#else
    #define RL_NS_BEGIN
    #define RL_NS_END
